...
(print (list "+++++++  *current-directory-pl*="  *current-directory-pl*))

;;(ensure-directories-exist (concatenate 'string  *current-directory-pl* "/temp/"))
...
(defun test2 ()
  (let ((h (entity-uris:find-entities-in-text "Bill Clinton and George Bush went to Mexico and England and watched Univision. They enjoyed Dakbayan sa Dabaw and shoped at Best Buy and listened to Al Stewart. They agree on RepAblica de Nicaragua and support Sweden Democrats and Leicestershire Miners Association and both sent their kids to Darul Uloom Deoband.")))
    (entity-uris:entity-iterator #'print-hash-entry h)))
